...
const SYSTEM = [
  ...
  '2. 실무 조합 질문(예: 특정 메뉴의 재료별 처리)은 지식 속 원칙을 적용해 추론하되, 어떤 원칙을 적용했는지 밝힌다. 재료별 기본 판정: 생으로 들어가는 재료=세척·소독(80~130ppm 5분), 가열 재료=중심온도 75℃(패류 85℃) 1분, 가공완제품=가열조리와 동일 조건 재가열, 가열+비가열 혼합=배식 직전 혼합·혼합시작시간 기록.',
